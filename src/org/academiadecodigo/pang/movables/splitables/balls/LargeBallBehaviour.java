 ...
 */
public class LargeBallBehaviour implements BallBehaviour {
    ...
    public LargeBallBehaviour(int yStart, int size) {
        this.yStart = yStart;

        maxY = YCoordinates.converter(GameConstants.PLAYER_HEIGHT + GameConstants.BALL_MIN_SIZE + 55) * 4;
